...
export const APP_NAME = 'KCD Assistant';

export const WEBUI_HOSTNAME = browser ? (dev ? `${location.hostname}:8080` : `${location.hostname}`) : '';
export const WEBUI_BASE_URL = '';  // 상대 경로 사용
export const WEBUI_API_BASE_URL = '/api/v1';

export const OLLAMA_API_BASE_URL = '/ollama';  // 상대 경로 사용
export const OPENAI_API_BASE_URL = '/openai';  // 상대 경로 사용
